...
class Options():
    def __init__(self):
        self.coarse_model_dir = '' # YOUR COARSE MODEL PATH
        self.dataset = "MO"
        self.ratio = 2.00
        self.description = "_"
    ...
    def parse(self):
        ...
        parser.add_argument('--fg', type=float, default=0.55)
        parser.add_argument('--bg', type=float, default=0.05)
        ...
        self.coarse_model_dir = f'{self.save_dir}/{self.dataset}/ratio{self.ratio}{self.description}/coarse/checkpoints/checkpoint_0.pth.tar'
        self.gpus = args.gpus
        self.random_seed = args.random_seed

        self.data = {}
        self.data['fg'] = args.fg
        self.data['bg'] = args.bg

        self.train = {}
        self.train['img_dir'] = f'{args.data_dir}/{args.dataset}/images/'
        self.train['vor_dir'] = f'{args.data_dir}/{args.dataset}/ratio{args.ratio}{args.description}/labels_vor/'
        self.train['clu_dir'] = f'{args.data_dir}/{args.dataset}/ratio{args.ratio}{args.description}/labels_clu/'
        self.train['aff_dir'] = f'{args.data_dir}/{args.dataset}/ratio{args.ratio}{args.description}/labels_aff/'
        self.train['save_dir'] = f'{args.save_dir}/{args.dataset}/ratio{args.ratio}{args.description}/fine/'
