...
class Options:
    ...
    def parse(self):
        ...
        self.train['save_dir'] = f'{args.save_dir}/{args.dataset}/ratio{args.ratio}{args.description}/coarse/'
    ...
    def save_options(self):
        filename = f'{self.save_dir}/{self.dataset}/ratio{self.ratio}{self.description}/coarse/options.txt'
